...
const TABS = [
  ...
  { id: 'pecas', label: 'Peças', icon: HardDrive },
];
          ...
          <div className="flex items-center justify-between h-18">
            <div className="flex items-center gap-4">
              ...
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="font-semibold">Loja CPF</span>
              </Link>
            </div>
        ...
        <div className="container-site">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold mb-3">
              <span className="text-gradient-cyan">Serviços</span> para você
            </h1>
            <p className="text-slate-400">
              Formatação, upgrades e manutenção com inteligência artificial.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="pb-32">
        <div className="container-site">
                  ...
                  >
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-400 line-clamp-2">{produto.descricao}</p>
                      </div>
                    </div>
                    
                    <div className="flex items-center justify-between pt-4 border-t border-white/5">
                      <div>
                        <span className="text-xl font-bold text-emerald-400">R$ {produto.preco}</span>
                        <p className="text-xs text-slate-500">{produto.capacidade}</p>
                      </div>
                      <button
                        onClick={() => addItem({
                          id: produto.id,
          ...
          {(activeTab === 'servicos' && filteredServicos.length === 0) || 
           (activeTab === 'pecas' && filteredProdutos.length === 0) ? (
