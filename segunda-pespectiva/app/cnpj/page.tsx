...
import { planosB2B } from '@/data/produtos';
    ...
    <div className="min-h-screen bg-[#050507]">
          ...
          <div className="flex items-center justify-between h-18">
            <div className="flex items-center gap-4">
              ...
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="font-semibold">Empresas (CNPJ)</span>
              </Link>
            </div>
        ...
        <div className="container-site">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              TI <span className="text-gradient-purple">inteligente</span> para sua empresa
            </h1>
            <p className="text-slate-400 mb-8">
              Migrações em massa com FOG Project, vibe coding, IA e suporte dedicado para transformar sua infraestrutura.
            </p>
      ...
      <section className="py-10 border-y border-white/5">
        <div className="container-site">
          ...
          >
            {[
              { icon: Server, title: "FOG Project", desc: "Migração em massa" },
              { icon: Code2, title: "Vibe Coding", desc: "Desenvolvimento rápido" },
              { icon: Brain, title: "IA Integrada", desc: "Otimização智能" },
              { icon: Shield, title: "SLA Garantido", desc: "Suporte prioritário" },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                variants={fadeInUp}
              ...
              >
                <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 flex items-center justify-center">
        ...
        <div className="container-site">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold">
              Serviços <span className="text-gradient-purple">Corporativos</span>
            </h2>
          </motion.div>
          ...
          >
            {[
              {
                title: "Migração FOG Project",
                description: "Instalação automática em várias máquinas simultaneamente com FOG Project.",
                icon: Server,
                price: "Sob consulta",
                features: ["Imagens customizadas", "Deploy em massa", "Backup automático"]
              },
              {
                title: "Vibe Coding & IA",
                description: "Desenvolvimento acelerado com IA para soluções corporativas.",
                icon: Code2,
                price: "Sob consulta",
                features: ["Automações inteligentes", "APIs personalizadas", "Dashboards analíticos"]
              },
              {
                title: "Rede Corporativa",
                description: "Setup completo de rede para sua empresa.",
                icon: Network,
                price: "Sob consulta",
                features: ["Servidores", "Wi-Fi empresarial", "VPN segura"]
              },
              {
                title: "Cloud & Infraestrutura",
                description: "Migração e gestão de infraestrutura cloud.",
                icon: Cloud,
                price: "Sob consulta",
                features: ["AWS/Azure/GCP", "Kubernets", "DevOps"]
              },
              {
                ...
                icon: Lock,
                price: "Sob consulta",
                features: ["Firewall", "Antivirus corporativo", "Backup enterprise"]
              },
              {
                ...
                icon: Headphones,
                price: "Sob consulta",
                features: ["24/7 disponível", "SLA 4-24h", "Técnico dedicado"]
              }
            ].map((service, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-lg font-medium text-sm bg-white/5 hover:bg-white/10 transition-colors"
                >
                  {service.price}
                </button>
              </motion.div>
      ...
      {/* Plans */}
      <section id="planos" className="section-spaced bg-[#0a0a0f]">
        <div className="container-site">
          <motion.div
            initial="hidden"
            whileInView="visible"
